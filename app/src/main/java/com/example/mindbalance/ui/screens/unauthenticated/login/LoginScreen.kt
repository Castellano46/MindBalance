package com.example.mindbalance.ui.screens.unauthenticated.login
...
import com.example.mindbalance.ui.common.customComposableViews.MediumTitleText
import com.example.mindbalance.ui.common.customComposableViews.TitleText
import com.example.mindbalance.ui.screens.unauthenticated.login.state.LoginUiEvent
    ...
    if (loginState.isLoginSuccessful) {
        ...
        Column(
                ...
                Column(
                    ...
                    MediumTitleText(
                        modifier = Modifier
                            ...
                            .fillMaxWidth(),
                        text = stringResource(id = R.string.mindbalance),
                    ...
                    AsyncImage(
                        ...
                        model = ImageRequest.Builder(LocalContext.current)
                            .data(data = R.drawable.header_login)
            ...
            Row(
                ...
                Text(text = stringResource(id = R.string.cachis))
                ...
                Text(
                    ...
                    text = stringResource(id = R.string.frgot_password),
